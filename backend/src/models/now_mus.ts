...
export class now_mus extends Model<InferAttributes<now_mus>, InferCreationAttributes<now_mus>> {
  declare lid: CreationOptional<number>
  declare museum: CreationOptional<string>

  // now_mus belongsTo com_mlist via museum
  declare museum_com_mlist?: Sequelize.NonAttribute<com_mlist>
  declare getMuseum_com_mlist: Sequelize.BelongsToGetAssociationMixin<com_mlist>
  declare setMuseum_com_mlist: Sequelize.BelongsToSetAssociationMixin<com_mlist, number>
