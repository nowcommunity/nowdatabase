...
export const TeethTab = () => {
  ...
  const mesowear = [
    ...
    ['Cusp Relief Low (OR%)', textField('mw_or_low', { type: 'number', integerOnly: true, min: 0, max: 100 })],
    ['Cusp Relief High (OR%)', textField('mw_or_high', { type: 'number', integerOnly: true, min: 0, max: 100 })],
    ['Cusp Shape Sharp (CS%)', textField('mw_cs_sharp', { type: 'number', integerOnly: true, min: 0, max: 100 })],
    ['Cusp Shape Rounded (CS%)', textField('mw_cs_round', { type: 'number', integerOnly: true, min: 0, max: 100 })],
    ['Cusp Shape Blunt (CS%)', textField('mw_cs_blunt', { type: 'number', integerOnly: true, min: 0, max: 100 })],
    ['Scale Minimum', textField('mw_scale_min', { type: 'number', integerOnly: true, min: 0 })],
    ['Scale Maximum', textField('mw_scale_max', { type: 'number', integerOnly: true, min: 0 })],
